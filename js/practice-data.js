// Practice Data from JSON - This should be in js/practice-data.js
const practiceData = {
  "pronunciation_practice_domains": {
    "metadata": {
      "total_domains": 4,
      "paragraphs_per_domain": 4,
      "total_practice_sessions": 16,
      "created_date": "2024-12-19",
      "version": "1.0",
      "description": "Multi-domain pronunciation practice content for advanced speech training"
    },
    "domains": {
      "SOCIAL": {
        "domain_id": "SOCIAL",
...
console.log('📊 Total domains available:', Object.keys(practiceData.pronunciation_practice_domains.domains).length);
